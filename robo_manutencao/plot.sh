...
set ylabel "Nós"
set output "nosexpandidos.png"

# plot 'testes3.txt' using 1:2 title 'Média' with linespoints ls 1 pointsize 0, 'testes3.txt' using 1:3 title 'Desvio padrão' with linespoints ls 4 pointsize 0
# plot 'testes3.txt' using 1:4 title 'Média' with linespoints ls 1 pointsize 0, 'testes3.txt' using 1:5 title 'Desvio padrão' with linespoints ls 4 pointsize 0
plot 'testes3.txt' using 1:6 title 'Média' with linespoints ls 1 pointsize 0, 'testes3.txt' using 1:7 title 'Desvio padrão' with linespoints ls 4 pointsize 0
